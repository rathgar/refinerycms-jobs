module Refinery
  class JobApplicationsController < ::ApplicationController
    ...
    def new
      @job_application = Refinery::JobApplication.new
      @job             = Refinery::Job.find(params[:job_id])

      present(@page)
    end

    def create
      @job_application        = Refinery::JobApplication.new(params[:job_application])
      ...
      respond_to do |format|
        if @job_application.save
          ...
          begin
            Refinery::JobMailer.deliver_notification(@job_application, request)
          rescue
    ...
    def show
      @job_application = Refinery::JobApplication.find(params[:id])
      @job             = @job_application.job
  ...
  protected
    ...
    def find_all_job_applications
      @jobs = Refinery::Job.find(:all, :order => "position ASC")
    end
